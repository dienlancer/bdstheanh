...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 21, 2018 lúc 05:45 AM
...
INSERT INTO `project` (`id`, `fullname`, `alias`, `meta_keyword`, `meta_description`, `image`, `count_view`, `total_cost`, `intro`, `overview`, `address`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES
...
(11, 'Opal Skyview 2', 'opal-skyview-2', 'metakeyword Opal Skyview 2', 'metadescription Opal Skyview 2', 'conmochieu-2.png', NULL, 200, 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source', '<p>tổng quan 2</p>', 'Khu căn hộ cao cấp Q.7 Tp. HCM', 2, 1, '2018-01-18 17:17:02', '2018-01-21 04:43:54'),
...
(1, 'admin', 'diennk@dienkim.com', 1, '$2y$10$qO/82Vqgmsa1TxcsuBiYAOL2IO3IqXQm51tiTBuX72396Lm1Ts2zm', NULL, '2018-01-20 21:08:01', 'Nguyễn Kim Điền', 'nguyen-kim-dien.png', 5, 1, '2017-11-12 07:23:56', '2018-01-20 21:08:01');
